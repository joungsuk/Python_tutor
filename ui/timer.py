...
class TimerApp:
    def __init__(self, root):
        ...
        self.start_stop_button = tk.Button(self.button_frame, text="시작/중지", command=self.toggle_timer)
        self.start_stop_button.pack(side="left", padx=(0,40))
        
        self.reset_button = tk.Button(self.button_frame, text="초기화", command=self.reset_timer)
